...
常に最新の状態を見せるために再読み込み
try: current_logs = conn.read(worksheet="シート1") if not current_logs.empty: if st.checkbox("最新の履歴を表示する"): st.dataframe(current_logs.tail(10), use_container_width=True, hide_index=True)
